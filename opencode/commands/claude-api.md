---
name: claude-api
description: Apply the claude-api skill to help with Claude API and Anthropic SDK tasks — model selection, prompt caching, tool use, streaming, and cost optimization.
---
